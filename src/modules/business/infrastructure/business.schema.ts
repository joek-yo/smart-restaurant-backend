...
// This replaces menu.json. Scoped per business. UI copy, delivery config,
// branding overrides. NOT product data — that lives on Product documents.
@Schema({ _id: false })
...
export class Business {
  ...
  @Prop({ type: StorefrontConfigSchema, default: () => ({}) })
